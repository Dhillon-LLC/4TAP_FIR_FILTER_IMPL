...
namespace eval ::optrace {
  variable script "C:/Users/surin/Documents/project/4TAP_FIR_FILTER_IMPL/make/pnr/adc_fir.runs/FIR_FIFO1_synth_1/FIR_FIFO1.tcl"
...
OPTRACE "FIR_FIFO1_synth_1" START { ROLLUP_AUTO }
...
set cached_ip [config_ip_cache -export -no_bom  -dir C:/Users/surin/Documents/project/4TAP_FIR_FILTER_IMPL/make/pnr/adc_fir.runs/FIR_FIFO1_synth_1 -new_name FIR_FIFO1 -ip [get_ips FIR_FIFO1]]
...
synth_design -top FIR_FIFO1 -part xc7k70tfbg484-3 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix FIR_FIFO1_ FIR_FIFO1.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ FIR_FIFO1_stub.v
 lappend ipCachedFiles FIR_FIFO1_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ FIR_FIFO1_stub.vhdl
 lappend ipCachedFiles FIR_FIFO1_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ FIR_FIFO1_sim_netlist.v
 lappend ipCachedFiles FIR_FIFO1_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ FIR_FIFO1_sim_netlist.vhdl
 lappend ipCachedFiles FIR_FIFO1_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp FIR_FIFO1.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips FIR_FIFO1]
 }
...
rename_ref -prefix_all FIR_FIFO1_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef FIR_FIFO1.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "FIR_FIFO1_synth_1_synth_report_utilization_0" "report_utilization -file FIR_FIFO1_utilization_synth.rpt -pb FIR_FIFO1_utilization_synth.pb"
